...
# A load-use hazard. A load writes to register x7, the following algorithmic/logic
# instructions needs the value stored in x7 immediately.
.global _start
...
_start: # prepare GPIO address (0x10004) and set registers for data sequence
	...
	ld x7, 8(x0)           # Data sequence: Load 5 from the memory to x7.
	add x10, x7, x5        # Data sequence: 5+6=x10=11 -> stall
	add x8, x7, x6         # Data sequence: x7 needs forwarding (5+7=x8=12)
